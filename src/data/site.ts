...
export const navGroups = [
  { label: 'Beranda', icon: '⌂', href: sitePath('/'), items: [{ label: 'Selayang Pandang', href: sitePath('/#selayang-pandang') }] },
  { label: 'PustakaMu', icon: '✦', href: sitePath('/pustaka'), items: [
    { label: 'Arab Dasar → Mahir', href: sitePath('/pustaka#arab') }, { label: 'Kitab Kuning', href: sitePath('/pustaka#kitab') }, { label: 'BukuMu', href: sitePath('/pustaka#bukumu') }, { label: 'Al Qur’anMu', href: sitePath('/pustaka#quranmu') }, { label: 'HaditsMu', href: sitePath('/pustaka#haditsmu') }
  ]},
  ...
  { label: 'Kontak', icon: '⌕', href: sitePath('/kontak'), items: [
    { label: 'WhatsApp & Telepon', href: sitePath('/kontak#hubungi') }, { label: 'SuaraMu', href: sitePath('/kontak#suaramu') }
  ]},
];
